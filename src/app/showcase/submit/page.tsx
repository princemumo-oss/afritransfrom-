  ...
  const onSubmit = async (data: InitiativeFormValues) => {
    ...
    try {
      ...
      toast({
        ...
        description: 'Your initiative has been submitted for review. You will be notified upon approval.',
      });
  ...
  return (
    <MainLayout>
      <div className="mx-auto grid w-full max-w-2xl gap-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Submit Your Initiative</CardTitle>
            <CardDescription>
              Fill out the form below to have your initiative, ministry, or project featured in the showcase. All submissions are subject to review.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
